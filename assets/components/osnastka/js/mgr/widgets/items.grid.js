Osnastka.grid.Items = function (config) {
    ...
    Osnastka.grid.Items.superclass.constructor.call(this, config);
...
Ext.extend(Osnastka.grid.Items, MODx.grid.Grid, {
    windows: {},
    ...
    getMenu: function (grid, rowIndex) {
        ...
        var menu = Osnastka.utils.getMenu(row.data['actions'], this, ids);
